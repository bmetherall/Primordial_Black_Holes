...
\centering
\input{Arrows}
\caption{Cousin's Theorem states that there exists a finite sub-cover of a closed interval. For example, take the interval $[1,2] \in \mathbb{R}$, then there exists a finite collection of circles (or more generally balls) spanning the interval.}
\label{fig:arrows}
\end{figure}
